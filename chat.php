    ...
    <div class="container">
        <div class="wrapper">
            <section class="chat-area">
                ...
                <form action="#" method="POST" class="typing-area" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <input type="text" name="msg" placeholder="Type a message here..." class="input-field">
                    <input type="file" name="file" id="file" hidden>
                    <label for="file" class="file-label"><i class="fa fa-file"></i></label>
